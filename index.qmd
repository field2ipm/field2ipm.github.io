...
*(13 August 2026)* Thank you all for a great inaugural course. We look forward to offering the course again in summer 2027.
:::
...
![Group photo of the 2026 Workshop at Maxfield Meadow. Photo credit: David Inouye.](photos/group_photo_01-IPM-workshop-RMBL-2026.jpeg){fig-alt="Group photo of workshop participants standing in a meadow with Gothic Mountain in the background." fig-align="center"}

![Workshop participants build Integral Projection Models for their own data.](photos/individual_model_work_03-IPM-workshop-RMBL-2026.jpeg){fig-alt="Workshop participants sitting at a conference table working on their laptops." fig-align="center"}

![Field demographic census exercise.](photos/heliomerus_demog_20-IPM-workshop-RMBL-2026.jpeg){fig-alt="Groups of people working together to set up plant demography plots in a montane meadow." fig-align="center"}

## Instructors

![](photos/will-valeriana.jpg){fig-alt="Will Petry sitting next to a very large plant rosette." fig-align="left" width="2in"} [Will Petry](https://parameterizeit.github.io/), North Carolina State University

![](photos/amy-delphinium.jpeg){fig-alt="Amy Iler next to a blue/purple-flowered plant." fig-align="left" width="2in"} [Amy Iler](https://amymarieiler.weebly.com/), Chicago Botanic Garden & Northwestern University

![](photos/paul-cactus.jpg){fig-alt="Paul CaraDonna standing next to a large barrel cactus" fig-align="left" width="2in"} [Paul CaraDonna](https://paulcaradonna.weebly.com/), Chicago Botanic Garden & Northwestern University
...
![](photos/hymenoxys-grandiflora.JPG){fig-alt="A yellow-flowered aster plant growing on a mountain ridge." fig-align="center" width="3in"}
